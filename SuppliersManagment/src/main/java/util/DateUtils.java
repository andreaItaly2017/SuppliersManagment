...
public class DateUtils {
  ...
  public static String formatDay(Date date) {
    if (date == null) {
      return("");
    	...
    	DateFormat dfUsFull = DateFormat.getDateTimeInstance();
      return(dfUsFull.format(date));
    }
  }
  ...
  public static String formatTime(Date date) {
    if (date == null) {
      ...
      return(String.format("%tl:%tM:%tS %tp on %tA, %tB %te, %tY",   date, date, date, date, date, date, date, date));
    }
  }
